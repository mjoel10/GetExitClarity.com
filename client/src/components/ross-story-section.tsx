        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-6 text-muted-foreground">
              ...
              <div className="bg-blue-50 p-8 rounded-xl border-l-4 border-primary mt-8">
                <p className="text-xl font-medium text-foreground italic mb-4" style={{ lineHeight: '1.5' }}>
            ...
            <div className="text-center">
              <div className="inline-block">
                ...
                <div className="mt-6 text-center">
                  ...
                  <p className="text-muted-foreground font-medium">Founder & CEO, ExitClarity</p>
