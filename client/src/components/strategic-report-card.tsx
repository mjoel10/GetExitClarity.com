        ...
        <div className="section">
          ...
          <div className="section-content">
            <div className="paragraph">
              Based on our comprehensive assessment yielding an Overall Exit Readiness Score of 82/100, we recommend <strong style={{ color: '#10b981', fontWeight: '800' }}>GO</strong> for TechFlow Solutions' market exit strategy. This score reflects strong fundamentals balanced against identified optimization opportunities for this established manufacturing technology company.
            </div>
            <div className="paragraph">
