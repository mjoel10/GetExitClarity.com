...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-16 pb-20 lg:pt-20 lg:pb-32 overflow-hidden">
      {/* Premium Background */}
          ...
          <div className="order-1 lg:order-1 flex flex-col space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed">
                ExitClarity shows in minutes if you should sell now, fix what's broken, or wait—giving you the clarity and roadmap you need to maximize your exit value.
              </p>
            </div>
