      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 mb-16">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground" style={{ lineHeight: '1.7' }}>Answer questions about your business in 5-7 minutes</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground" style={{ lineHeight: '1.7' }}>Algorithm analyzes against 1000+ successful exits</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground" style={{ lineHeight: '1.7' }}>Detailed report with valuation and action plan</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg border">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Hybrid Report Visual - Wider Layout */}
            <div className="bg-white rounded-2xl p-6 border shadow-lg w-full max-w-2xl mx-auto relative">
              ...
              {/* Bottom Section: Written Content Preview */}
              <div className="grid grid-cols-3 gap-4">
                {/* Executive Summary */}
            ...
            <div>
              ...
              <ul className="space-y-5 text-sm text-muted-foreground" style={{ lineHeight: '1.7' }}>
